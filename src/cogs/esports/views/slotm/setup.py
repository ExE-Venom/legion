...
class ScrimsSlotManagerSetup(EsportsBaseView):
    ...
    async def initial_message(guild: discord.Guild):
        ...
        _e.description = (
            f"Slot-Manager is a way to ease-up scrims slot management process. With slotm users can - "
...
#                return await self.ctx.premium_mango("You need Legion Premium to add more than 1 Slot-Manager channel.")
