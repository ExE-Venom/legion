...
class MediaPartnerView(EsportsBaseView):
    ...
    async def initial_embed(self):
        ...
        embed.description = (
            f"With media-partnership you can make {self.ctx.config.BOT_NAME} handle media partner registrations "
            f"that means {self.ctx.config.BOT_NAME} will check if the user have registered in the partner server "
...
#                "You need Premium to download Ms Excel file containing all the "
#                f"registration data of your tourn"
